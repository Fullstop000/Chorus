...
/**
 * Catalog: qa/cases/channels.md — CHN-003 Channel Rename Updates Sidebar Immediately
 * Supersedes: CHN-005
 */
test.describe('CHN-003', () => {
  test('Channel rename updates sidebar immediately without full refresh @case CHN-003', async ({
    page,
  }) => {
    ...
    await createUserChannelViaUi(page, original, 'playwright CHN-003')
