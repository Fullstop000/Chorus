          ...
          <div className="profile-identity">
            ...
            <div className="profile-activity-status">
              <span
                ...
                style={{ background: activityDotColor(agent.activity) }}
              />
      ...
      <DialogContent>
        ...
        <div className="modal-choice-list">
          ...
          >
            ...
            <span className="modal-choice-body">
              Remove the Chorus record and keep workspace files on disk.
            </span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="modal-choice-body">
              Remove the Chorus record and delete the workspace directory.
            </span>
          </button>
        </div>
        {error && <FormError>{error}</FormError>}
